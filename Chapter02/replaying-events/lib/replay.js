...
exports.builder = {
  bucket: {
    alias: "b",
    default: "cncb-data-lake-s3-cozycole-bucket-kgyn8iwujuyo",
  },
  prefix: {
    alias: "p",
    default: `cozycole-cncb-event-stream-s1`,
    // default: `${now.format('YYYY')}/${now.format('MM')}/${now.format('DD')}/`
  },
  function: {
    alias: "f",
    default: "cncb-replaying-events-listener-cozycole",
  },
  dry: {
    alias: "d",
    default: true,
